...
def brpc_workspace():
  ...
  native.new_http_archive(
    ...
    build_file = str(Label("//:build_tools/bazel/third_party/leveldb.BUILD")),
  ...
  native.new_http_archive(
    ...
    build_file = str(Label("//:build_tools/bazel/third_party/glog.BUILD")),
  ...
  native.new_git_repository(
    ...
    build_file = "//:build_tools/bazel/third_party/google_styleguide.BUILD",
